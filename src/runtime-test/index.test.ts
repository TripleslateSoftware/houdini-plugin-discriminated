...
// import { test_config } from "houdini-svelte/test";
// import { discriminated } from "./index";
// import {
...
//         Object.entries(row.artifacts ?? {}).map(([key, value]) => [
//           key,
//           { raw: value },
//         ])
//       );

//       const extracted = await extract_load_function(
//         config,
//         targetPath,
//         artifacts
//       );
...
//       expect(
//         extracted.houdini_load?.map((operation) => operation.name!.value)
//       ).toEqual(row.expected.houdini_load ?? []);
//     });
//   }
// });
